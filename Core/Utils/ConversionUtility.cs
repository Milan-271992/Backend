...
namespace Core.Utils
{
    public class ConversionUtility
    {
        ...
        public String NumberToText(String pNumber, ConversionType pConversionType, Language pDisplayLanguage)
        {
            try
            {
        ...
        public T ConvertFromDynamicObject<T>(dynamic data)
        {
            var options = new JsonSerializerOptions { PropertyNameCaseInsensitive = true };
            return JsonSerializer.Deserialize<T>(JsonSerializer.Serialize(data, options));
        }

        //public IQueryable<T> OrderByNew<T>(this IQueryable<T> source, string columnName, string sortby)
        //{
        ...
        //}
        public T ConvertFromDynamicStringToObject<T>(dynamic data)
        {
            return JsonSerializer.Deserialize<T>(JsonSerializer.Deserialize(data).ToString());
        }
        public T ConvertFromDynamicObjectToString<T>(dynamic data)
        {
            return JsonSerializer.Serialize(data);
        }
        public Dictionary<string, string> ConvertFromDynamicStringToDictionary(dynamic data)
        {
        ...
        private String ConvertMonthIntoWords(Int16 pMonthNumber, Language pDisplayLanguage)
        {
            try
            {
        ...
        private String ConvertToWord(String pAmount, ConversionType pConversionType, Language pDisplayLanguage)
        {
            try
            {
        ...
        public JsonSerializerOptions GetDeserializationPolicy()
        {
		...
		#endregion
		public static T ConvertFromDynamicObjectExportColumn<T>(object obj)
		{
